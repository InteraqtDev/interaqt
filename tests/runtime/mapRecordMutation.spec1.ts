...
describe('map interaction', () => {
    ...
    test('map interaction to relation', async () => {
        ...
        const requests1 = await controller.system.entities.find('Post', undefined, undefined, ['*'])
        ...
        const posts = await controller.system.entities.find('Post', undefined, undefined, ['*'])
        ...
        const revisions = await controller.system.entities.find('PostRevision', undefined, undefined, ['*', ['current', {attributeQuery: ['*']}]])
        ...
        const revisions3 = await controller.system.entities.find('PostRevision', undefined, undefined, ['*', ['current', {attributeQuery: ['*']}]])

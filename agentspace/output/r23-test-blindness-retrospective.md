...
3. **声明面对齐守卫**:Dictionary defaultValue∥computation(对齐 Property)、Entity 空 inputEntities(对齐 Relation)、Property/Dictionary type 白名单、Entity.clone(deep)(对齐 Relation.clone)——「一侧有守卫、对称侧没有」的寄生缺口收一批。

...
| --- | --- | --- | --- | --- | --- |
| `Custom` | added / changed / downstream / async handler / state-only | added / chain / deletion / `_isDeleted_` destructive scope | non-Transform output blocked | non-Transform output blocked | function review, async handler, side-effect isolation |
| `Transform` | N/A | N/A | added / changed / stale cleanup / ownership proof | added relation output | event-based Transform blocked without handler; full compute skips null consistently |
| `Count` | added / filtered downstream / relation path downstream | relation aggregate migration events | N/A | N/A | related mutation event shape covered |
| `Summation` | downstream from changed Transform | existing relation aggregate matrix baseline | N/A | N/A | dependency ordering covered |
| `Average` | added global, changed/unchanged review | added relation property aggregate | N/A | N/A | state rebuild via full compute covered |
| `WeightedSummation` | added global, changed/unchanged review | added relation property aggregate | N/A | N/A | callback review covered |
| `Any` | added global, changed/unchanged review | added relation property aggregate | N/A | N/A | callback review covered |
| `Every` | added global, changed/unchanged review | added relation property aggregate | N/A | N/A | callback review covered |
| `RealTime` | added global | added property | N/A | N/A | callback review and state writes covered |
| `StateMachine` | handler-driven migration | handler-driven migration | N/A | N/A | missing handler blocked, handler result validation covered |

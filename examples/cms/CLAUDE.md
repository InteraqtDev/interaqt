...
```
agentspace/knowledge/llm_generator_guide.md
```
...
1. **Read the LLM Generator Guide**:
   - Load `agentspace/knowledge/llm_generator_guide.md` completely
...
2. **For Project Generation Requests**:
   ```
   I will follow the test-case driven development workflow from llm_generator_guide.md:

...
19. **When using Interactions, add InteractionEventEntity** - If you have `interactionDependencies`, you MUST also include `InteractionEventEntity` in `dependencies`

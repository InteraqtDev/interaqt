...
exports.getRequirementsWebviewContent = getRequirementsWebviewContent;
function buildRequirementTree(data) {
    const rootRequirements = data.root_read_requirements || [];
    const derivedRequirements = data.derived_requirements || {};
    function buildNode(req, level) {
        const node = { ...req, children: [], level };
...
function getAllRequirements(data) {
    const all = [...(data.root_read_requirements || [])];
...
function getRequirementsWebviewContent(data, _webview) {
...
function generateRequirementCards(requirements) {
...
//# sourceMappingURL=requirementsWebviewContent.js.map
...
exports.getComputationWebviewContent = getComputationWebviewContent;
function getComputationWebviewContent(data, _webview) {
...
function generateEntityCards(entities) {
...
function generatePropertyItems(properties) {
...
function generateRelationCards(relations) {
...
function generateDictionaryCards(dictionaries) {
...
function generateValidationView(validation) {
...
function getComputationClass(decision) {
    if (!decision)
        return 'none';
    const lower = decision.toLowerCase();
    if (lower.includes('transform'))
        return 'transform';
    if (lower.includes('statemachine'))
        return 'statemachine';
    if (lower.includes('count') || lower.includes('summation') || lower.includes('every'))
        return 'count';
    if (lower.includes('_owner') || lower === 'owner')
        return 'owner';
    if (lower.includes('_parent') || lower.startsWith('parent'))
        return 'parent';
    if (lower.includes('static') || lower === 'none')
        return 'static';
    return 'none';
}
...
//# sourceMappingURL=computationWebviewContent.js.map
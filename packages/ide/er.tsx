...
// import { data as activityData} from '../runtime/tests/data/simpleActivity'
import { data as erAndActivityData } from '../runtime/tests/data/simpleER'
...
if (erAndActivityData) {
    // createInstancesFromString(cache)
    createInstances(erAndActivityData, true)
} else {
...
root.render(<EREditor entities={Entity.instances} relations={Relation.instances} activities={Activity.instances}/>)

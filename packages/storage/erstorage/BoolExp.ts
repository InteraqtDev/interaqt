...
//     }
// })
export type BoolAtomData = {
    type: string
    data: any
}


export type UnwrappedBoolExpressionInstanceType<T>  = {
    type: string,
    operator: string,
    left: UnwrappedBoolExpressionInstanceType<T> | BoolAtomData,
    right?: UnwrappedBoolExpressionInstanceType<T> |  BoolAtomData,
} 
...
export type BoolExpressionData = {
    type: string
    operator: string
    left: BoolAtomData | BoolExpressionData
    right?: BoolAtomData | BoolExpressionData
}   
